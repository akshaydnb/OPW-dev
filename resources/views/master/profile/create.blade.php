            ...
            <div class="panel-body">
                <form id="movieForm" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="businessName" autofocus />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="officialEmailID" />
                    </div>
                    <div class="form-group">
                        <label class="control-label">Authorized Signature Name</label>
                        <input type="number" class="form-control" name="authorizeSignatureName" />
                    </div>
                    <div class="form-group">
