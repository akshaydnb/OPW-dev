<div class="modal fade" id="modal-reject" tabindex="-1" role="dialog" aria-labelledby="modalForm">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form name="form-reject" id="form-reject">        
                <div class="modal-header">
                    <h4 class="modal-title">Reject Order</h4>
                </div>
                <div class="modal-body clearfix">
                    <div class="form-group">
                        <label for="inventory" class="control-label">Adjust Inventory</label>
                        <select class="form-control" name="inventory"  id="inventory">
                            <option value="Free Inventory">Free Inventory</option>
                            <option value="Add To Damage">Add To Damage</option>
                        </select>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="modal-approve" tabindex="-1" role="dialog" aria-labelledby="modalForm">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form name="form-approve" id="form-approve">        
                <div class="modal-header">
                    <h4 class="modal-title">Approve Order</h4>
                </div>
                <div class="modal-body clearfix">
                    <div class="form-group">
                        <label for="approveReason" class="control-label">Reason</label>
                        <textarea class="form-control" name="approveReason" id="approveReason"></textarea>
                    </div>
                </div>                
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal">Close</button>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form name="form-add-PI" id="form-add-PI">        
                <div class="modal-header">
                    <h4 class="modal-title">Add Sales Item</h4>
                </div>
                <div class="modal-body clearfix" id="div-main">
                    ...
                    <div class="form-group col-xs-12 col-md-4">
                        <label for="with" class="control-label">Product with</label>
                        <select class="form-control" name="with"  id="with">
                            <option value="">No Link Product</option>
                            <option value="Sent Frame/Goggles">Sent Frame/Goggles</option>
                            <option value="Add Frame">Add Frame</option>
                            <option value="Add Goggles">Add Goggles</option>
                        </select>
                    </div>
                    <div class="form-group col-xs-12 col-md-4">
                    ...
                    <div class="form-group col-xs-12 col-md-6 table-responsive">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th><input type="checkbox" name="r" /></th>
                                    <th>R-SPL</th>
                                    <th>R-CYL</th>
                                    <th>R-AXIS</th>
                                    <th>R-PD</th>
                            ...
                            <tbody>
                                <tr>
                                    <td>D</td>
                                    <td><input type="text" class="form-control" id="DR-SPL" name="DR-SPL"></td>
                                    <td><input type="text" class="form-control" id="DR-SPL" name="DR-CYL"></td>
                                    <td><input type="text" class="form-control" id="DR-SPL" name="DR-AXIS"></td>
                                    <td><input type="text" class="form-control" id="DR-SPL" name="DR-PD"></td>
                                </tr>
                                <tr>
                                    <td>N</td>
                                    <td><input type="text" class="form-control" id="NR-SPL" name="NR-SPL"></td>
                                    <td><input type="text" class="form-control" id="NR-SPL" name="NR-CYL"></td>
                                    <td><input type="text" class="form-control" id="NR-SPL" name="NR-AXIS"></td>
                                    <td><input type="text" class="form-control" id="NR-SPL" name="NR-PD"></td>
                                </tr>
                            </tbody>
                        </table>    
                    </div> 
                    <div class="form-group col-xs-12 col-md-6 table-responsive">
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th><input type="checkbox" name="l" /></th>
                                    <th>L-SPL</th>
                                    <th>L-CYL</th>
                                    <th>L-AXIS</th>
                                    <th>L-PD</th>
                            ...
                            <tbody>
                                <tr>
                                    <td>D</td>
                                    <td><input type="text" class="form-control" id="DL-SPL" name="DL-SPL"></td>
                                    <td><input type="text" class="form-control" id="DL-SPL" name="DL-CYL"></td>
                                    <td><input type="text" class="form-control" id="DL-SPL" name="DL-AXIS"></td>
                                    <td><input type="text" class="form-control" id="DL-SPL" name="DL-PD"></td>
                                </tr>
                                <tr>
                                    <td>N</td>
                                    <td><input type="text" class="form-control" id="NL-SPL" name="NL-SPL"></td>
                                    <td><input type="text" class="form-control" id="NL-SPL" name="NL-CYL"></td>
                                    <td><input type="text" class="form-control" id="NL-SPL" name="NL-AXIS"></td>
                                    <td><input type="text" class="form-control" id="NL-SPL" name="NL-PD"></td>
                                </tr>
                            </tbody>
                        </table>    
                    </div> 
                ...
                <div class="modal-body clearfix hidden" id="div-sheet">
                    <div class="table-responsive">
                        <table class="table table-bordered table-custom-grid highlight" cellspacing="0">
                            <colgroup></colgroup>
                            <colgroup></colgroup>
                            <colgroup></colgroup>
                            <colgroup></colgroup>
