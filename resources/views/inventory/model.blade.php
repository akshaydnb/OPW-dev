...
<div class="modal fade" id="modal-split-inventory" tabindex="-1" role="dialog" aria-labelledby="modalForm">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form name="form-add-SI" id="form-add-SI">        
                <div class="modal-header">
                    <h4 class="modal-title">Split Inventory</h4>
                </div>
                <div class="modal-body clearfix">
                    <div class="form-group">
                        <label class="control-label">Frame : plastic, round shape, black</label>
                        <label class="control-label pull-right">Quantity : 100</label>
                    </div>
                    <div class="form-group form-inline div-SI-list clearfix">
                        <div class="form-group">
                            &nbsp;&nbsp;&nbsp;&nbsp;
                        </div>
                        <div class="form-group ">
                    ...
                    <div class="form-group" id="div-add-SI">
                        <button type="button" class="btn btn-info" onclick="addSI()" >Add new Size</button>
                    </div>
                </div>                
            ...
            <div class="form-inline copy-SI hidden">
                <div class="form-group">
                    <a href="#" class="remove"><i class="fa fa-times-circle fa-lg text-danger"></i></a>
                </div>
                <div class="form-group">
                    <label for="size" class="control-label">Size&nbsp;</label>
...
<!-- MODAL : ADD PRODUCT ITEM DETAILS -->
<div class="modal fade" id="modal-add-TI" tabindex="-1" role="dialog" aria-labelledby="modalForm">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form name="form-add-TI" id="form-add-TI">        
                <div class="modal-header">
                    <h4 class="modal-title">Add Transfer Item</h4>
                </div>
                <div class="modal-body clearfix" id="div-main">
                    ...
                    <div class="form-group col-xs-12 col-md-4 gst-details hidden">
