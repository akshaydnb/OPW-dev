            ...
            <div class="panel-body">
                <form id="movieForm" method="post">
                    <div class="form-group">
                        <div class="row gutter">
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="fromBranch" autofocus>
                    ...
                    <div class="form-group">
                        <div class="row gutter">
                            <div class="col-md-6">
                                ...
                                <select class="form-control" name="billType" id="billType" onchange="showGSTInfo();" >
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="ewayBill" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8 no-padding">
                        <button type="button" class="btn btn-info" id="button-add-TI" data-toggle="modal" data-target="#modal-add-TI" data-backdrop="static">Add Transfer Item</button>
                    </div>
