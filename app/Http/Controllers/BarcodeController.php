...
{
    private $viewPrefix = 'master.barcode.';
    private $routePrefix = 'barcode.';

    public function index()
    {
        $barcodes = Barcode::with('product','gst')->orderBy('created_at', 'desc')->get();
        return view($this->viewPrefix . 'index', compact('barcodes'));
    }
